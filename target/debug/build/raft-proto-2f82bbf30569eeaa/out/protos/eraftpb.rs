...
impl SnapshotMetadata {
    ...
    pub fn get_pending_membership_change(&self) -> &ConfState {
        self.pending_membership_change.as_ref().unwrap_or_else(|| <ConfState as ::protobuf::Message>::default_instance())
    }
...
impl ConfChange {
    ...
    pub fn get_configuration(&self) -> &ConfState {
        self.configuration.as_ref().unwrap_or_else(|| <ConfState as ::protobuf::Message>::default_instance())
    }
